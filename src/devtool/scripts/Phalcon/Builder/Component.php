...
abstract class Component
{
    ...
    {
        foreach (array('/app/config/devtool','app/config/devtool') as $configPath) {
        ...
        foreach ($iterator as $f) {
            if (preg_match('app/config/devtool\.php$/i', $f->getPathName())) {
                $config = include $f->getPathName();

                return $config;
            }
            // } else {
            //     if (preg_match('config/devtool\.ini$/i', $f->getPathName())) {
