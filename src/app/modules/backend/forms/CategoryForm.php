...
class CategoryForm extends Form {
    ...
    public function init() {
        ...
        $parent_id = new Text('parent_id');
		$parent_id->setLabel($this->_('parent_id'));
        $parent_id->addValidator(new StringLength(array(
        		'max' => 11, 
        		'messageMaximum' => $this->_('%n% is too long. Maximum %m% characters', array('n' => 'parent_id', 'm' => 11)))
        ));
        ...
        $status->setOptions(Category::listStatus());				

		
        $groupBody = new Group('box-body', array(
		$parent_id, $title, $thumbnail, $quote, $decscription, $created_date, $updated_date, $meta_title, $meta_description, $meta_keywords, $status			
